...
public class Tests {
    ...
    void unregister() {
        ...
        assertAll(() -> assertFalse(groupAdmin.getObservers().contains(members[0])),
                () -> assertEquals(NUM_OF_MEMBERS - 1, groupAdmin.getObservers().size()));
        ...
        assertEquals(0, groupAdmin.getObservers().size());
    ...
    void append() {
        ...
        logger.info(() -> "After append, the total size of the groupAdmin is: " + JvmUtilities.objectTotalSize(groupAdmin));
        logger.info(() -> JvmUtilities.objectFootprint(groupAdmin));
        logger.info(() -> "JVM info: " + JvmUtilities.jvmInfo());
        System.out.println("-----------------------------------------------------------------------------------------" + System.lineSeparator());
    ...
    void delete() {
        ...
        logger.info(() -> "After deletion, the total size of the groupAdmin is: " + JvmUtilities.objectTotalSize(groupAdmin));
        logger.info(() -> JvmUtilities.objectFootprint(groupAdmin));
        logger.info(() -> "JVM info: " + JvmUtilities.jvmInfo());
        System.out.println("-----------------------------------------------------------------------------------------" + System.lineSeparator());
    ...
    void undo() {
        ...
        logger.info(() -> "After undo, the total size of the groupAdmin is: " + JvmUtilities.objectTotalSize(groupAdmin));
        logger.info(() -> JvmUtilities.objectFootprint(groupAdmin));
        logger.info(() -> "JVM info: " + JvmUtilities.jvmInfo());
        System.out.println("-----------------------------------------------------------------------------------------" + System.lineSeparator());
    }
    ...
    void update() {
        UndoableStringBuilder usb = new UndoableStringBuilder();
        ConcreteMember cm = new ConcreteMember("Member1");
        assertEquals(null, cm.getUsb());
        cm.update(usb);
        assertEquals("", cm.getLastChange());
        usb.append("Hello");
        cm.update(usb);
        assertEquals(usb, cm.getUsb());
        assertEquals("Hello", cm.getLastChange());
        usb.append(" World");
        cm.update(usb);
        assertEquals("Hello World", cm.getLastChange());

        logger.info(() -> "After update, the total size of the Concrete Member is: " + JvmUtilities.objectTotalSize(cm));
